...
namespace NetChatGptCLient.Models.ChatGpt
{
    ...
    public static class OpenAIChatGptModels
    {
        ...
        /// <summary>
        /// GPT-4 is a large multimodal model that can solve difficult problems with greater accuracy than any of our previous models, thanks to its broader general knowledge and advanced reasoning capabilities.
        /// It is optimized for chat but works well for traditional completions tasks.
        /// </summary>
        /// <remarks>
